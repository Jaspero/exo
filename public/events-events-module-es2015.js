...
class EventsListComponent {
    ...
    ngOnInit() {
        this.events$ = this.scully.available$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(item => console.log(item)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(items => items.filter(it => it.route.includes('/events/'))));
    }
}
...
EventsListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EventsListComponent, selectors: [["exo-events-list"]], decls: 38, vars: 3, consts: [[1, "main", "relative"], [1, "grid", "h-full", "jc-start", "ai-end", "c-light"], [1, "col-6", "col-s-12", "z-index"], [1, "ta-left", "exo-headline"], [1, "col-12", "ta-left", "z-index"], [1, "grid", "m-y-l"], [1, "col-6", "col-s-12", "ta-center"], [1, "m-y-l"], [1, "grid", "jc-around", "ai-center", "m-y-m"], [1, "col-4", "col-xs-12", "c-dark", "ta-left"], [1, "m-t-s"], [1, "col-5", "col-xs-12", "ta-right"], ["src", "assets/images/events/events-lounge.png"], [1, "m-y-l", "bg-full"], ["class", "relative flex bg-container m-y-l", 4, "ngFor", "ngForOf"], [1, "exo-events", "m-t-l", "flex", "jc-center", "ai-center"], [1, "col-6", "wrapper", "relative", "c-light", "z-index", "ta-center", "flex", "fd-col", "ai-center", "jc-center"], [1, "z-index", "m-y-m"], [1, "btn-secondary", "z-index"], [1, "relative", "flex", "bg-container", "m-y-l"], [1, "custom-bg-r"], [1, "events-party", "relative", 3, "ngStyle"], [1, "card-right", "bg-light", "p-a-l"], [1, "m-y-m"], [1, "btn-primary"]], template: function EventsListComponent_Template(rf, ctx) { if (rf & 1) {
