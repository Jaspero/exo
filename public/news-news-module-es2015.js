...
function NewsListComponent_div_18_Template(rf, ctx) { if (rf & 1) {
...
function NewsListComponent_li_20_Template(rf, ctx) { if (rf & 1) {
...
class NewsListComponent {
            ...
            news: [
                {
                    ...
                    category: 'Nail-bar',
                    newsDescription: 'EXO Industries is a brand of lifestyle services. The company currently consists of EXO Loun' +
    ...
    ngOnInit() {
        this.news$ = this.scully.available$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(items => items.filter(it => it.route.includes('/news/'))));
    }
}
NewsListComponent.ɵfac = function NewsListComponent_Factory(t) { return new (t || NewsListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_2__["ScullyRoutesService"])); };
NewsListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NewsListComponent, selectors: [["exo-news-list"]], decls: 23, vars: 4, consts: [[1, "main", "relative"], [1, "grid", "h-full", "jc-start", "ai-end", "c-light"], [1, "col-6", "col-s-12", "z-index"], [1, "ta-left", "exo-headline"], [1, "col-12", "ta-left", "z-index"], [1, "grid", "m-y-l"], [1, "col-6", "col-s-12", "ta-center"], [1, "m-y-l"], ["class", "grid jc-between ai-center b-b p-y-m", 4, "ngFor", "ngForOf"], [4, "ngFor", "ngForOf"], [1, "grid", "jc-between", "ai-center", "b-b", "p-y-m"], [1, "col-5", "col-s-6", "col-xs-12", "ta-left"], [3, "src"], [1, "col-4", "col-s-6", "col-xs-12", "c-dark"], [1, "flex", "ai-center", "jc-between", "w-full", "m-t-s"], [1, "category"], [1, "m-t-s"], [1, "btn-primary", "m-t-l"], [3, "routerLink"]], template: function NewsListComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _component_news_list_news_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./component/news-list/news-list.component */ "./src/app/news/component/news-list/news-list.component.ts");
/* harmony import */ var _component_news_news_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./component/news/news.component */ "./src/app/news/component/news/news.component.ts");
...
/* harmony import */ var _scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @scullyio/ng-lib */ "./node_modules/@scullyio/ng-lib/__ivy_ngcc__/fesm2015/scullyio-ng-lib.js");
/* harmony import */ var _component_news_news_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./component/news/news.component */ "./src/app/news/component/news/news.component.ts");
/* harmony import */ var _component_news_list_news_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./component/news-list/news-list.component */ "./src/app/news/component/news-list/news-list.component.ts");
...
NewsModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({ type: NewsModule });
NewsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function NewsModule_Factory(t) { return new (t || NewsModule)(); }, imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _news_routing_module__WEBPACK_IMPORTED_MODULE_5__["NewsRoutingModule"], _scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_2__["ScullyLibModule"], _shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"]]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](NewsModule, { declarations: [_component_news_news_component__WEBPACK_IMPORTED_MODULE_3__["NewsComponent"], _component_news_list_news_list_component__WEBPACK_IMPORTED_MODULE_4__["NewsListComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _news_routing_module__WEBPACK_IMPORTED_MODULE_5__["NewsRoutingModule"], _scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_2__["ScullyLibModule"], _shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](NewsModule, [{
