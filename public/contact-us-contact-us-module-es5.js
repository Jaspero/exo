...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["contact-us-contact-us-module"], {
  ...
  function srcAppContactUsContactUsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ContactUsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 120,
      vars: 1,
      consts: [[1, "main", "relative"], [1, "main-wrapper", "flex", "fw-wrap", "jc-start", "ai-end", "p-x-xl", "p-s-0"], [1, "col-6", "col-s-12", "z-index", "m-l-l", "m-s-0"], [1, "c-light", "ta-left", "contact-heading"], [1, "col-12", "flex", "jc-between", "ai-center", "c-light", "z-index"], [1, "col-4", "m-l-m", "m-s-0"], [1, "grid", "m-y-l"], [1, "col-7", "col-xs-12", "ta-center"], [1, "contact", "m-y-l"], [1, "col-12", "ta-center"], [1, "col-4", "col-xs-12", "flex", "ai-center", "jc-center"], ["src", "assets/icons/pin.svg", "alt", "", 1, "m-r-xs", "icon", "m-b-s"], ["src", "assets/icons/phone.svg", "alt", "", 1, "m-r-xs", "icon"], ["src", "assets/icons/mail.svg", "alt", "", 1, "m-r-xs", "icon"], [1, "col-12", "m-y-l", "ta-center"], [1, "col-3", "col-xs-6", "ta-center"], ["href", ""], [1, "col-8", "col-s-12", "fw-wrap", "no-padding", "flex", "jc-around"], ["class", "col-6 col-xs-12 flex fd-col ai-center fw-wrap", 4, "ngFor", "ngForOf"], [1, "col-10", "col-s-12", "flex", "fw-wrap"], [1, "col-6", "col-xs-12", "relative", "m-y-m"], ["type", "text", "required", "", 1, "w-full", "inputs"], [1, "highlight"], [1, "bar"], ["type", "number", "required", "", 1, "w-full", "inputs"], [1, "col-12", "relative", "m-y-m"], [1, "col-3", "col-s-6", "ta-center"], [1, "send"], [1, "col-12", "ta-center", "m-y-l"], [1, "flex", "jc-center", "w-full", "ai-center", "m-t-m"], ["src", "assets/icons/facebook-black.svg", "alt", "social-icon"], ["src", "assets/icons/instagram-black.svg", "alt", "social-icon", 1, "m-x-m"], ["src", "assets/icons/twitter-black.svg", "alt", "social-icon"], [1, "m-y-m"], [1, "location", "w-full", "m-y-l"], [1, "exo-events", "m-t-l", "flex", "jc-center", "ai-center"], [1, "col-6", "col-xs-12", "wrapper", "relative", "c-light", "z-index", "ta-center", "flex", "fd-col", "ai-center", "jc-center"], [1, "z-index", "m-y-m"], [1, "btn-secondary", "z-index"], [1, "col-6", "col-xs-12", "flex", "fd-col", "ai-center", "fw-wrap"], ["class", "flex jc-between col-8 no-padding", 4, "ngFor", "ngForOf"], [1, "flex", "jc-between", "col-8", "no-padding"]],
