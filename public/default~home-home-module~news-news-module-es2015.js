...
NewsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NewsComponent, selectors: [["exo-news"]], decls: 76, vars: 0, consts: [[1, "main", "relative"], [1, "main-wrapper", "flex", "fw-wrap", "jc-start", "ai-end", "p-x-xl", "p-s-0"], [1, "col-6", "col-s-12", "z-index", "m-l-l", "m-s-0"], [1, "c-light", "ta-left", "exo-headline"], [1, "col-12", "flex", "jc-between", "ai-center", "c-light", "z-index"], [1, "col-6", "m-l-m", "m-s-0"], [1, "grid", "m-y-l"], [1, "col-7", "ta-left"], [1, "m-y-s"], [1, "category"], [1, "col-10", "news-img", "m-y-l"], [1, "col-7", "m-y-m"], [1, "m-y-m"], [1, "m-y-l"]], template: function NewsComponent_Template(rf, ctx) { if (rf & 1) {
...
//# sourceMappingURL=default~home-home-module~news-news-module-es2015.js.map