...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! @angular/router */
    "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js"); // import {slideInAnimation, aboutAnimate} from './animations';
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
        ...
        args: [{
          ...
          styleUrls: ['./app.component.scss'] // animations: [ slideInAnimation, aboutAnimate]
  ...
  function srcAppHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 41,
      vars: 4,
      consts: [[1, "header", "c-light"], [1, "flex", "jc-between", "ai-center"], [1, "col-4", "z-index"], ["routerLink", "/", "routerLinkActive", "active"], [1, "col-8", "flex", "jc-end", "z-index", "m-r-l", "hide-s"], ["routerLink", "/lounge", "routerLinkActive", "active", 1, "m-x-s"], ["routerLink", "/nail", "routerLinkActive", "active", 1, "m-x-s"], ["routerLink", "/experiences", "routerLinkActive", "active", 1, "m-x-s"], ["routerLink", "/about", "routerLinkActive", "active", 1, "m-x-s"], ["routerLink", "/contact", "routerLinkActive", "active", 1, "m-x-s"], [1, "z-index", "show-s"], [1, "mobile-menu", "m-r-m", "z-index", 3, "click"], [1, "line-1"], [1, "line-2"], [1, "line-3"], [1, "col-10", "flex", "fw-wrap", "jc-center", "ai-center", "bg-light", "c-dark", "fd-col", "z-index", "mobile-links"], ["routerLink", "/", "routerLinkActive", "active", 1, "mobile-link", "p-y-s"], ["routerLink", "/lounge", "routerLinkActive", "active", 1, "mobile-link", "p-y-s"], ["routerLink", "/nail", "routerLinkActive", "active", 1, "mobile-link", "p-y-s"], ["routerLink", "/experiences", "routerLinkActive", "active", 1, "mobile-link", "p-y-s"], ["routerLink", "/about", "routerLinkActive", "active", 1, "mobile-link", "p-y-s"], ["routerLink", "/contact", "routerLinkActive", "active", 1, "mobile-link", "p-y-s"]],
