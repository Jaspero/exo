...
function ShopListComponent_div_20_img_3_Template(rf, ctx) { if (rf & 1) {
...
function ShopListComponent_div_20_Template(rf, ctx) { if (rf & 1) {
    ...
    const background_r15 = ctx.$implicit;
...
class ShopListComponent {
    ...
    ngOnInit() {
        this.blogs$ = this.scully.available$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(items => items.filter(it => it.route.includes('/shop/'))));
    }
}
ShopListComponent.ɵfac = function ShopListComponent_Factory(t) { return new (t || ShopListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_2__["ScullyRoutesService"])); };
ShopListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ShopListComponent, selectors: [["exo-shop-list"]], decls: 22, vars: 1, consts: [[1, "main", "relative"], [1, "grid", "h-full", "jc-start", "ai-end", "c-light"], [1, "col-6", "col-s-12", "z-index"], [1, "ta-left", "exo-headline"], [1, "col-12", "ta-left", "z-index"], [1, "grid", "m-y-l"], [1, "col-6", "col-s-12", "ta-center"], [1, "m-y-l"], [1, "grid", "jc-start"], ["class", "col-6 m-y-m relative", 4, "ngFor", "ngForOf"], [1, "col-6", "m-y-m", "relative"], [1, "product-wrapper", 3, "ngStyle"], [1, "img-wrapper", "flex", "jc-center", "ai-end"], ["alt", "", "class", "soap-product", 3, "src", 4, "ngFor", "ngForOf"], [1, "m-t-xl"], [1, "m-y-m"], [1, "btn-primary"], ["alt", "", 1, "soap-product", 3, "src"]], template: function ShopListComponent_Template(rf, ctx) { if (rf & 1) {
...
function ShopComponent_ul_94_Template(rf, ctx) { if (rf & 1) {
...
ShopComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ShopComponent, selectors: [["exo-shop"]], decls: 100, vars: 1, consts: [[1, "main", "relative"], [1, "main-wrapper", "flex", "fw-wrap", "jc-start", "ai-end", "p-x-xl", "p-s-0", "relative"], [1, "col-6", "col-s-12", "z-index", "m-l-l", "m-s-0"], [1, "c-light", "ta-left", "exo-headline"], [1, "col-12", "ta-left", "c-light", "z-index"], [1, "grid", "jc-between", "m-y-xl"], [1, "col-4"], [1, "img-wrapper", "ta-center", "b-a"], ["src", "assets/images/shop/shop-single-product.png", "alt", ""], [1, "flex", "ai-center", "jc-between", "w-full", "m-t-s"], [1, "product-wrapper", "ta-center", "b-a"], ["src", "assets/images/shop/product-small.png", "alt", "", 1, "product"], [1, "col-6"], [1, "title"], [1, "price", "b-b", "m-y-m", "p-b-s"], [1, "btn-primary", "m-t-m"], [1, "grid", "m-y-l"], [1, "col-12", "flex", "b-b"], [1, "m-x-s"], [1, "col-12"], [1, "m-y-s"], ["type", "square", 4, "ngFor", "ngForOf"], ["type", "square"]], template: function ShopComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "exo-header");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "\n");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "section", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, "\n  ");
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _component_shop_list_shop_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./component/shop-list/shop-list.component */ "./src/app/shop/component/shop-list/shop-list.component.ts");
/* harmony import */ var _component_shop_shop_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./component/shop/shop.component */ "./src/app/shop/component/shop/shop.component.ts");
...
/* harmony import */ var _component_shop_shop_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./component/shop/shop.component */ "./src/app/shop/component/shop/shop.component.ts");
/* harmony import */ var _component_shop_list_shop_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./component/shop-list/shop-list.component */ "./src/app/shop/component/shop-list/shop-list.component.ts");
...
ShopModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function ShopModule_Factory(t) { return new (t || ShopModule)(); }, imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _shop_routing_module__WEBPACK_IMPORTED_MODULE_6__["ShopRoutingModule"], _scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_2__["ScullyLibModule"], _shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"]]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](ShopModule, { declarations: [_component_shop_shop_component__WEBPACK_IMPORTED_MODULE_4__["ShopComponent"], _component_shop_list_shop_list_component__WEBPACK_IMPORTED_MODULE_5__["ShopListComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _shop_routing_module__WEBPACK_IMPORTED_MODULE_6__["ShopRoutingModule"], _scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_2__["ScullyLibModule"], _shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"]] }); })();
